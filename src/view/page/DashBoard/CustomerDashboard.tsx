...
export function CustomerDashboard() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 relative overflow-hidden">
            ...
            <div className="relative z-10 py-8 px-4 lg:px-8 animate-fade-in">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-8">
                        <div className="customer-dashboard-content-card lg:col-span-7 bg-white/60 backdrop-blur-xl rounded-2xl border border-white/50 p-8 flex flex-col shadow-sm hover:shadow-md transition-all duration-300">
                        ...
                        {/* Top Destinations */}
                        <div className="customer-dashboard-content-card lg:col-span-5 bg-white/60 backdrop-blur-xl rounded-2xl border border-white/50 p-8 flex flex-col shadow-sm hover:shadow-md transition-all duration-300">
                    ...
                    {(stats.monthlySpending.length > 0 || stats.weeklySpending?.length || stats.hourlySpending?.length || stats.yearlySpending?.length) && (
                        <div className="customer-dashboard-content-card bg-white rounded-3xl border border-gray-100 p-10 shadow-sm transition-all hover:shadow-md">
